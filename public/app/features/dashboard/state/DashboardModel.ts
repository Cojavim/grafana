...
export class DashboardModel {
  ...
  showOtherRelativeRanges: boolean;
  ...
  constructor(data: any, meta?: DashboardMeta) {
    ...
    this.showRelativeRanges = data.showRelativeRanges || false;
    this.showOtherRelativeRanges = data.showOtherRelativeRanges || false;
    this.mobileView = data.mobileView || false;
    this.absoluteBefore = data.absoluteBefore || false;
